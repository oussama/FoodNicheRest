...
import com.foodnicherest.Subscriptions;
 ...
 */
@Stateless
@Path("com.foodnicherest.subscriptions")
public class SubscriptionsFacadeREST extends AbstractFacade<Subscriptions> {
    @PersistenceContext(unitName = "com_FoodNicheRest_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    public SubscriptionsFacadeREST() {
