...
import com.foodnicherest.Subcsriptiontypes;
 ...
 */
@Stateless
@Path("com.foodnicherest.subcsriptiontypes")
public class SubcsriptiontypesFacadeREST extends AbstractFacade<Subcsriptiontypes> {
    @PersistenceContext(unitName = "com_FoodNicheRest_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    public SubcsriptiontypesFacadeREST() {
