...
import com.foodnicherest.Coupondownloads;
 ...
 */
@Stateless
@Path("com.foodnicherest.coupondownloads")
public class CoupondownloadsFacadeREST extends AbstractFacade<Coupondownloads> {
    @PersistenceContext(unitName = "com_FoodNicheRest_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    public CoupondownloadsFacadeREST() {
