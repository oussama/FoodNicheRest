...
public class Businesses implements Serializable {
    ...
    @ManyToOne
    private Businesstypes businesstypeid;
    @OneToMany(mappedBy = "businessid")
    ...
    public Businesstypes getBusinesstypeid() {
        return businesstypeid;
    }

    public void setBusinesstypeid(Businesstypes businesstypeid) {
